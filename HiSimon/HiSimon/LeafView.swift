...
public class LeafView: UIView {
    ...
    var shapes = [#imageLiteral(resourceName: "EmptyOvalFall"), #imageLiteral(resourceName: "FullOvalFall"), #imageLiteral(resourceName: "EmptySquareFall"), #imageLiteral(resourceName: "EmptyTriangleFall2")]
    ...
    public func startLeaf(duration: TimeInterval = 0) {
        ...
        for birthRate in  birthRates {
            emitter.birthRate = Float(birthRate)
        }
